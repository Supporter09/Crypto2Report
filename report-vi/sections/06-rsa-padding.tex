...
\item tạo ra một đầu vào RSA có cấu trúc, trong đó mỗi bit đầu ra phụ thuộc vào toàn bộ thông điệp lẫn hạt giống.
\end{itemize}
...
\end{tikzpicture}
\caption{OAEP kết hợp khối dữ liệu DB và một hạt giống ngẫu nhiên qua hai hàm sinh mặt nạ $G$ và $H$ trước khi áp dụng RSA. Mỗi bit đầu ra của $\mathrm{EM}$ phụ thuộc vào toàn bộ thông điệp và toàn bộ hạt giống.}
\end{figure}
