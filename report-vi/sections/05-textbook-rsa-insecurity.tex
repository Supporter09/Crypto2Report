...
\]
Không phải khóa nào cũng phân tích được như vậy; chẳng hạn một khóa phiên là số nguyên tố thì không thể tách theo cách này. Do đó tấn công chỉ thành công với phần các khóa có cả hai thừa số nằm dưới ngưỡng đã chọn, và ngưỡng được lấy là $2^{34}$ thay vì $2^{32}$ chính là để bao phủ được nhiều khóa hơn. Với những khóa đó, đối thủ có thể dùng chiến lược meet-in-the-middle:
